...
/**
 * Rule validate
 * price_min phải >= price_max
 * Có thể nhập price_min mà không cần nhập price_max và ngược lại
 */
    ...
    <div className='py-4'>
      ...
      <ul>
        {categories.map((categoryItem) => {
          const isAcive = category === categoryItem._id
          return (
            <li className='py-2 pl-2 ' key={categoryItem._id}>
              <Link
                ...
                className={classNames('relative px-2', {
                  'text-orange font-semibold': isAcive
                })}
              >
                {isAcive && (
